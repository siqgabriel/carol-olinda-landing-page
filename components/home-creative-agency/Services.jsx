...
function Services() {
  ...
  return (
    <section className="services-modern section-padding2">
      <div className="container">
        <div className="sec-head mb-80">
          <div className="row">
            <div className="col-lg-4">
              <h6 className="title-bord mb-30">soluções</h6>
            </div>
            <div className="col-lg-8">
              <div className="text">
                <h4 style={{ fontWeight: '200 !important' }}>
                  Soluções estratégicas para desenvolver líderes, fortalecer a cultura organizacional e transformar aprendizagem em resultados reais para o negócio.
                </h4>
              </div>
            </div>
          </div>
