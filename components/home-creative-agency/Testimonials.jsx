            ...
            <div className="sec-head">
              ...
              <h3 className="fw-600 d-rotate wow">
                <span className="rotate-text">
                  Veja alguns <span className="fw-200">Feedbacks</span>
                </span>
              </h3>
            </div>
          </div>
                  ...
                  <div className="item">
                    <div className="content">
                      <div className="text">
                        ...
                        <p className="fz-30">
                          A Carol consegue transformar temas complexos em experiências de aprendizagem extremamente práticas e impactantes.”
                        </p>
                      </div>
                      <div className="info d-flex align-items-center pt-40 mt-40 bord-thin-top">
                        ...
                        <div className="ml-20">
                          ...
                          <span className="sub-title main-color">
                            Executivo de Desenvolvimento Organizacional
                          </span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="item">
                    <div className="content">
                      <div className="text">
                        ...
                        <p className="fz-30">
                          O programa de liderança desenvolvido por ela elevou o nível das nossas lideranças e gerou mudanças reais na cultura.
                        </p>
                      </div>
                      <div className="info d-flex align-items-center pt-40 mt-40 bord-thin-top">
                        <div>
                        ...
                        <div className="ml-20">
                          <h5>João Silva</h5>
                          <span className="sub-title main-color">
                            Gerente de RH – Empresa do setor financeiro
                          </span>
                        </div>
                      </div>
                    </div>
